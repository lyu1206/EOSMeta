...
namespace Battlehub.RTEditor
{
    public class GameObjectEditor : MonoBehaviour
    {
        ...
        private void InitAddComponentControl()
        {
            ...
            if (exposeToEditor &&
                (m_settingsComponent == null || m_settingsComponent.BuiltInWindowsSettings.Inspector.ShowAddComponentButton) &&
                (project == null || project.Utils.ToProjectItem(SelectedGameObject) == null))
            {
                if (m_addComponentControl != null)
                {
                    m_addComponentControl.ComponentSelected += OnAddComponent;
