    ...
    public class RuntimeObjects : MonoBehaviour, IRuntimeObjects
    {
        ...
        public IEnumerable<ExposeToEditor> Get(bool rootsOnly, bool useCache)
        {
            if(rootsOnly)
            {
                if (m_editor.IsPlaying)
                {
                    ...
                    return m_playModeCache.Where(o => o.GetParent(true) == null);
                }
                else
                {
                    if (!useCache)
                    ...
                    return m_editModeCache.Where(o => o.GetParent(true) == null);
                }
            }
        ...
        private void OnPlaymodeStateChanging()
        {
            if (m_editor.IsPlaying)
            {
                ...
                var editCache = m_editModeCache.OrderBy(eo => eo.transform.GetSiblingIndex());
